                    ...
                    <div class="col-12">
                        <div class="card">
                             ...
                             <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" action="<?= base_url('admin/add_psikolog_run'); ?>" method="post">
                                <div class="row">
                                        
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-6">Nama</label>
                                            <input type="text" name="nmpsig" class="form-control form-control-line">
                                        </div>
