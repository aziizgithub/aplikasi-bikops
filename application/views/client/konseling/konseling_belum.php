                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-6">Nama</label>
                                            <input readonly type="text" name="nmpsig" class="form-control form-control-line">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-6">Email</label>
                                            <input readonly type="text" name="email" class="form-control form-control-line" readonly>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-6">bidang</label>
                                            ...
                                            <input  readonly type="text" name="nohp" class="form-control form-control-line">
                                    ...
                                    <div class="form-group">
                                       <label class="col-md-6">Jenis Kelamin</label>
                                        <input class="form-control form-control-line" type="text" name="jk" readonly>
